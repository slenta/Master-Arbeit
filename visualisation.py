...
def visualisation(iter):
    ...
    f = h5py.File('../Asi_maskiert/results/images/Maske_1970/10_60_12/test_' + iter + '.hdf5', 'r')
    ...
    plt.savefig('../Asi_maskiert/results/images/Maske_1970/10_60_12/test_' + iter + '.pdf')
    plt.show()
